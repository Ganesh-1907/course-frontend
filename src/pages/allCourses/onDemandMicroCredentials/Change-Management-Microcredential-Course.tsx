...
const ChangeManagementMicrocredentialCourse = () => {
    ...
    const courseFeatures = [
        ...
        { icon: Settings, title: 'Frameworks', subtitle: 'Change Ready', color: 'bg-blue-50 text-blue-600' },
                    ...
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-[minmax(0,1fr)_340px]">
                        <div className="space-y-12">
                            ...
                            <CourseCorporateOptUs
                                courseName="Why Simpliaxis for Corporate Change Management Training?"
                                description="Simpliaxis delivers customized corporate training programs designed to strengthen change management capability and ensure successful Agile transformation. Our expert-led sessions empower organizations to reduce resistance, improve engagement, and achieve sustainable transformation outcomes."
                                label=""
