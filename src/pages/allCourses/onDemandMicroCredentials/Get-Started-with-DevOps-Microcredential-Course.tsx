                    ...
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-[minmax(0,1fr)_340px]">
                        <div className="space-y-12">
                            ...
                            <CourseCorporateOptUs
                                courseName="Why Simpliaxis for Corporate DevOps Training?"
                                description="Simpliaxis delivers tailored corporate DevOps training programs designed to enhance collaboration, automation, and delivery efficiency. Our expert-led sessions help organizations adopt DevOps best practices, accelerate digital transformation, and improve software reliability across teams."
                                label=""
