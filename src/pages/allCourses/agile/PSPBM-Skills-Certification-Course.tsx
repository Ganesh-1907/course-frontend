...
const PSPBMSkillsCertificationCourse = () => {
  ...
  const certificationSteps = [
    {
      ...
      "description": "Enroll in the PSPBM Skills Certification Training with Simpliaxis."
    },
    {
  ...
  const corporateData = {
    ...
    "description": "Simpliaxis provides practical, trainer-led Scrum learning experiences designed to improve Product Backlog Management, collaboration, and value delivery across enterprise teams."
  };
