  ...
  return (
    <div className="py-24 bg-slate-50 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-full pointer-events-none opacity-40">
        ...
        <div className="absolute bottom-1/4 right-0 w-96 h-96 bg-accent/20 rounded-full blur-[120px]" />
      </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-20 border-b border-slate-200 pb-10">
          <div className="space-y-4">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-[#001c3d] tracking-tight leading-[1.1]">
              {subtitle.split("Viovn")[0]}<span className="text-primary">Viovn</span>{subtitle.split("Viovn")[1]}
            </h2>
          </div>
            ...
            >
              <div className="flex gap-6 p-4">
                ...
                <div className="space-y-3">
                  <h3 className="text-[19px] font-black text-[#001c3d] group-hover:text-primary transition-colors">
                    {feature.title}
                  </h3>
