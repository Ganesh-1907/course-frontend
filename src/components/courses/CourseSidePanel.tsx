...
const CourseSidePanel: React.FC<CourseSidePanelProps> = ({ schedules, courseId, courseName }) => {
  ...
  const handleSelectPlan = (plan: 'Basic' | 'Premium') => {
    ...
    const enrollItem = {
      courseId: String(featuredSchedule.id),
  ...
  return (
    <div className="space-y-3">
        ...
        <div className="p-3 space-y-3">
          ...
          <div className="space-y-1.5">
            <Button
              ...
              disabled={loading}
              className={`w-full font-black text-[13px] rounded-md h-9 shadow-md transition-all active:scale-[0.98] flex items-center justify-center gap-2 ${inCart
      ...
      </motion.div>      {/* Plan Selection Modal */}
